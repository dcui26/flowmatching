...
def main(args):
    ...
    data = torch.load(os.path.join(args.save_dir, 'couplings.pt'))
    all_x0 = data['x0']
    all_x1 = data['x1']
    print(f"Loaded {len(all_x0)} couplings")

    loader = Rectify.make_data_loader(all_x0, all_x1, args.batch_size, args.num_workers)
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        for x0, x1 in loader:
            ...
            loss = Rectify.loss(model, x0, x1, t)
